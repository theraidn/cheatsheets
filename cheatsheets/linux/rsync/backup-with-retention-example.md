# Backup with retention example via rsync
...
SOURCES="/my/source/directory"
TARGET="/the/destination/backup/path"
...
RSYNCCONF=(--delete)
#MOUNTPOINT=/media/RPi               # check local mountpoint
#MAILREC="user@domain"

#SSHUSER="syncpi"
#FROMSSH="192.168.0.102"
#TOSSH="tossh-server"
#SSHPORT=22
